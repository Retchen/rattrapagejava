        ...
        <div class="modal-content">
            ...
            <form method="post" action="/seatingplanfront/add/emplacement">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label>Mat&eacute;riel(s)</label>
                        <c:forEach items="${gammes}" var="g" >
                            <div class="input-group">
                                <span class="input-group-addon"><c:out value="${g.nom}" /></span>
                                <input type="hidden" name="gammes[]" value="<c:out value="${g.id}" />">
                                <input type="text" class="form-control" name="materiels[]">
                            </div>
                        </c:forEach>
                    </div>
                </div>
