...
<div class="container">
    ...
    <form id="formEmplacement" method="post" action="/seatingplanfront/add/materiels">
    <div id="header">
        <h2>
        ...
        <div class="col-md-4">
            <h3>Mat&eacute;riel(s) : </h3>
            <ul class="list-group">
                <c:forEach items="${materiels}" var="mat">
                    <div class="input-group">
                        <span class="input-group-addon"><c:out value="${mat.key.nom}" /></span>
                        <input type="hidden" name="gammes[]" value="<c:out value="${mat.key.id}" />">
                        <input type="hidden" name="ids[]" value="<c:out value="${mat.value.id}" />">
                        <input type="text" class="form-control col-md-8" name="materiels[]" value="${mat.value.nom}">
                    </div>
                </c:forEach>
            </ul>
        </div>
        ...
        <div class="modal-content">
            <form action="/seatingplanfront/edit/emplacement" method="post">
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="modalAddPersonnes">Ajout d'occupant(s)</h4>
                </div>
                <div class="modal-body">
                    <div class="form-group">
                        <label>S&eacute;lectionner les personnes &#224; ajouter</label>
